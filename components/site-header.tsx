...
export function SiteHeader() {
  ...
  return (
    <header className="flex bg-black rounded-t-2xl h-16 shrink-0 items-center gap-2 border-b transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-20">
